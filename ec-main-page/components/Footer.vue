  ...
  <footer class="bg-[#0D2170] flex flex-col gap-9 sm:gap-15 py-10 px-5 text-white sm:p-15 xl:p-20">
    <div class="w-full flex flex-col gap-9 sm:gap-15">
      ...
      <div class="w-full flex flex-col gap-5 items-center">
        <h2 class="text-3xl sm:text-4xl font-medium text-center leading-10">Zostaw nam swoje dane, a skontaktujemy się z Tobą</h2>
      ...
      <form id="contactForm" @submit.prevent="submit" class="text-base flex flex-col lg:flex-row justify-between gap-8 lg:gap-30">
        <div class="flex flex-col gap-8 flex-1">
          <div class="formRow">
            ...
            <input type="text" id="title" name="title" placeholder="Wpisz..." required v-model="contactFormData.title" class="h-[40px] mt-3 w-full border-b border-[#A2C6FF] bg-transparent">
          </div>
          <div class="formRow">
            <label for="phone">Numer telefonu<span class="text-red-600">*</span></label>
            <input type="tel" id="phone" name="phone" placeholder="Wpisz..." required v-model="contactFormData.phone" class="h-[40px] mt-3 w-full border-b border-[#A2C6FF] bg-transparent">
          </div>
          <div class="formRow">
            <label for="email">Email<span class="text-red-600">*</span></label>
            <input type="email" id="email" name="email" placeholder="Wpisz..." required v-model="contactFormData.email" class="h-[40px] mt-3 w-full border-b border-[#A2C6FF] bg-transparent">
          </div>
        </div>
        <div class="flex flex-col gap-8 flex-1">
          <div class="formRow area">
            <label for="body">Wiadomość</label>
            <textarea id="body" name="body" rows="4" v-model="contactFormData.body" class="h-[80px] mt-3 w-full border-b border-[#A2C6FF] bg-transparent"></textarea>
          </div>
          ...
          <div id="sender" class="flex flex-col gap-3 justify-between">
            ...
            <p>Możesz również skontaktować się z nami pod numerem <span class="font-medium">+48 668 420 820</span></p>
          </div>
        </div>
      </form>
